...
+ (void)drawFill:(id)arg1 forPath:(id)arg2 atIndex:(long long)arg3 inRect:(struct CGRect)arg4 hasInnerStroke:(BOOL)arg5 hasBackgroundBlur:(BOOL)arg6 context:(id)arg7;
@property(nonatomic) struct CGRect rect; // @synthesize rect=_rect;
@property(nonatomic) BOOL compensateForBlur; // @synthesize compensateForBlur=_compensateForBlur;
