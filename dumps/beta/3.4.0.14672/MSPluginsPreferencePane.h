...
@class BCKeyEventActionTableView, MSPluginManager, NSArray, NSArrayController, NSButton, NSCache, NSControl, NSImage, NSLayoutConstraint, NSMenu, NSPredicate, NSString, NSTableCellView, NSTextField;
