...
+ (struct CGPoint)findFirstAvailablePositionNextToArtboardsOnPage:(id)arg1;
+ (BOOL)shouldPlaceArtboardRectInGrid:(struct CGRect)arg1 onPage:(id)arg2;
...
+ (id)insertPasteboardData:(id)arg1 intoParent:(id)arg2 atPosition:(struct CGPoint)arg3;
+ (id)findFirstParent:(id)arg1 thatCanContainRect:(struct CGRect)arg2;
...
+ (struct CGRect)targetRectForPasteboardData:(id)arg1 inViewPort:(id)arg2 root:(id)arg3;
